...
class ResultadosView:
    def __init__(self, root, main):
        self.root = root
        self.main = main  # Función para volver atrás
        #self.resultados_excel_view = resultados_excel_view  # Referencia a ResultadosExcelView
        self.resultados_view = tk.Frame(self.root)
    ...
    def start_auto_save(self):
        """Inicia el hilo de auto guardado en intervalos regulares si hay un archivo seleccionado."""
        print(f"selected_file: {self.selected_file}")  # Imprimir para ver su valor
